    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Question counter in middle top
          Text(
          ...
          // Feedback and next options (only show after answer is submitted)
          if (showAnswer) ...[
            const SizedBox(height: 16),
            ...
            // Next Question and Ask for Explanation buttons
            Row(
              children: [
                Expanded(
                  child: ElevatedButton(
