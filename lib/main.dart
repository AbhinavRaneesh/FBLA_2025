...
class _PracticeModeScreenState extends State<PracticeModeScreen> {
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      widget.studySet['name'] ?? 'Practice Mode',
                      style: const TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                        color: Colors.white,
              ...
              children: [
                ...
                SliderTheme(
                  ...
                  child: Slider(
                    ...
                    divisions:
                        _questions.length > 1 ? _questions.length - 1 : 1,
  ...
  Widget _buildScoreSummary() {
    return Center(
      key: const ValueKey('scoreSummary'),
      child: Container(
        ...
        Padding(
          ...
          child: Column(
            children: List.generate(
              _questions[_currentQuestionIndex]['options'].split('|').length,
              (index) {
                final option = _questions[_currentQuestionIndex]['options']
                    .split('|')[index];
